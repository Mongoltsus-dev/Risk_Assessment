...
const REQUIRED_POLICIES = [
  {
    ...
    description:
      "Байгууллагын кибер аюулгүй байдлын эрсдэлийг удирдах үндсэн бодлого. NIST CSF 2.0 GV.PO-01 шаардлагын дагуу тогтоогдсон, мэдэгдсэн, хэрэгжүүлэгдсэн байх ёстой.",
  ...
  },
  {
    ...
    description:
      "Байгууллагын эрсдэлийн менежментийн зорилт, хүрээ, хариуцлагыг тодорхойлсон бодлого. NIST CSF 2.0 GV.RM-01 шаардлага.",
    category: "Эрсдэлийн менежмент",
  ...
  },
  {
    ...
    description:
      "Удирдлагын кибер аюулгүй байдлын эрсдэлд хариуцлага хүлээх, дүр үүргийг тодорхойлсон бодлого. NIST CSF 2.0 GV.RR-01 шаардлага.",
    category: "Нийцлийн удирдлага",
  ...
  },
  {
    ...
    description:
      "Зөвшөөрөлтэй хэрэглэгч, үйлчилгээ, техник хангамжийн хандалтыг удирдах бодлого. MFA, нууц үг, эрхийн зарчим. NIST CSF 2.0 PR.AA-01 шаардлага.",
  ...
  },
  {
    ...
    description:
      "Хадгалагдаж байгаа болон дамжуулагдаж байгаа өгөгдлийн шифрлэлт, ангилал, хамгааллыг тодорхойлсон бодлого. NIST CSF 2.0 PR.DS-01 шаардлага.",
    category: "Мэдээллийн аюулгүй байдал",
  ...
  },
  {
    ...
    description:
      "Хөрөнгийн эмзэг байдлыг тодорхойлох, үнэлэх, засах үйл явцыг тодорхойлсон бодлого. NIST CSF 2.0 ID.RA-01 шаардлага.",
    category: "Эрсдэлийн менежмент",
  ...
  },
  {
    ...
    description:
      "Сүлжээ, систем, үйл явдлыг хортой үйлдлийн эсрэг хяналт тавих бодлого. SIEM, EDR, лог бүртгэлийн хамрах хүрээ. NIST CSF 2.0 DE.CM-01 шаардлага.",
    category: "Мэдээллийн аюулгүй байдал",
  ...
  },
  {
    ...
    description:
      "Кибер аюулгүй байдлын зөрчлийн хариу арга хэмжээний төлөвлөгөө, дүр үүрэг, харилцааны бодлого. NIST CSF 2.0 RS.MA-01 шаардлага.",
  ...
  },
  {
    ...
    description:
      "Кибер аюулгүй байдлын зөрчлийн үед болон дараа нь үйл ажиллагааг сэргээх төлөвлөгөө, нөөцлөлт, RTO/RPO зорилт. NIST CSF 2.0 RC.RP-01 шаардлага.",
  ...
  },
  {
    ...
    description:
      "Гуравдагч этгээд, нийлүүлэгч, хамтрагч байгууллагуудтай холбоотой кибер аюулгүй байдлын эрсдэлийг удирдах бодлого. NIST CSF 2.0 GV.SC шаардлага.",
    category: "Эрсдэлийн менежмент",
    csf_subcategory_ids:
  ...
  },
  {
    ...
    description:
      "Нийлүүлэгч, SaaS, outsource үйлчилгээний гэрээнд MFA, logging, incident notification, data handling, right-to-audit зэрэг security requirement тусгах бодлого.",
    category: "Нийцтэй байдлын удирдлага",
...
async function getPolicyById(id: number) {
  const res = await pool.query(
    `SELECT p.*, cu.full_name AS created_by_name, au.full_name AS approved_by_name,
  ...
  try {
    ...
    const result = await pool.query(`
      SELECT
        ...
        p.required_items, p.organization_response, p.csf_subcategory_ids,
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    if (body.approve !== undefined) {
      ...
      const approvedById = toInt(body.approved_by);

      if (isApprove) {
        // Fetch current frequency to compute next_review_at
        const cur = await pool.query(
          "SELECT review_frequency, document_file_path FROM policies WHERE id = $1",
          [id],
        );
    ...
    if (body.submit) {
      ...
      if (
        ...
        !cur.rows[0]?.organization_response
      ) {
        return NextResponse.json(
          {
            message:
              "Байгууллагын тайлбар / хэрэгжилтийн мэдээлэл шаардлагатай",
          },
          { status: 400 },
        );
      }
