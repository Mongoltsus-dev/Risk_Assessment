    ...
    children: [
      ...
      table(
        ...
        [
          ...
          ["/action-plan", "Арга хэмжээний төлөвлөгөө", "Remediation tracking — owner, due date, status"],
      ...
      table(
        ...
        [
          ...
          ["Respond (RS)", "Orange", "/action-plan", "No incident log, no response playbooks"],
      ...
      para("The /action-plan auto-syncs from control recommendations and allows status/owner/due date management. This is solid. What is missing:"),
      ...
      numbered("Action plan overdue badge — on /action-plan, highlight rows where due_date is before today and status is not Done or Accepted"),
